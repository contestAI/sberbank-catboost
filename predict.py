...
if __name__ == '__main__':
    ...
    parser.add_argument('--test-csv', default='../sberbank_data/check_{}_{}/test.csv'.format(dataset, tasktype))
    parser.add_argument('--prediction-csv', type=argparse.FileType('w'),
